...
<template>
  ...
  <div class="gv-content">
    ...
    <ToolsSection               v-else-if="activeTab === 'tools'" :scope="{ kind: 'global' }" />
    ...
    <LogStreamSection
      ...
      :fetch-logs="fetchServerLogs"
      :fetch-modules-fn="fetchServerLogModules"
      :fetch-sources-fn="fetchServerLogSources"
    />
  </div>
</template>
