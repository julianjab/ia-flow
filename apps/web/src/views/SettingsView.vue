...
import ProyectoSection from '../components/settings/ProyectoSection.vue';
import AgentesSection from '../components/settings/AgentesSection.vue';
...
import TareasSection from '../components/settings/TareasSection.vue';
import EntornoSection from '../components/settings/EntornoSection.vue';
import ArchivosSection from '../components/settings/ArchivosSection.vue';
