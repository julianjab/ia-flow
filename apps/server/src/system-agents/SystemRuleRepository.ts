 ...
 * al asistente (`base-agents.yaml`) cuando se evalúan eventos del proyecto
 * reservado del chat — sin que salga de la tabla `rules` ni sea editable
 * desde el CRUD. El resto de los métodos (list/upsert/delete/setPositions)
 * pasan directo: esta regla no se puede tocar desde ahí a propósito.
 */
