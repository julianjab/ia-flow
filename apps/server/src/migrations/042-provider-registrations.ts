...
// de apps/ai-provider-gateway (dominio+puerto+credencial) y a cuál de sus
...
// (GET /v1/providers del gateway) para no depender de que esté vivo en cada
...
const migration: Migration = {
  ...
  description: 'Create provider_registrations table (remote ai-provider-gateway instances)',
  up(db) {
    db.run(`
