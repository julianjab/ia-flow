...
//
// Espejo deliberado de apps/server/src/logger-sinks.ts, byte a byte salvo esta
// nota. No vive en un package compartido porque las dos apps ya son procesos
// independientes que no comparten nada más (ver el CLAUDE.md raíz sobre
// `workspace`/`github-auth`), y esto es autocontenido: sin ese acoplamiento,
// mantenerlo en sync a mano cuando cambie es más simple que justificar un
// package nuevo para dos consumidores que ya duplican su logger.ts entero.
//
